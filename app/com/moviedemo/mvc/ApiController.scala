...
import com.moviedemo.data.models.HasId
import play.api.mvc._
import play.api.libs.json._
import RequestOps._
import play.api.libs.json.JsObject
import com.moviedemo.tools.ParseOp
import com.moviedemo.mvc.Formats._
...
object ApiController {
  ...
  implicit def getErrors(errors: JsError): String = com.moviedemo.tools.Conversions.getErrors(errors)
